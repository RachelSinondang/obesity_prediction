...
shinyServer(function(input, output) {
    ...
    output$plot_rate <- renderPlotly({
        ...
        death_rate_plot <- ggplot(death_rate %>% filter(Entity == "South Africa"| Entity == "Afghanistan"),aes(x = Year, y = Death_rate_from_obesity, group = Entity, color = Entity, text = glue("{Entity}
